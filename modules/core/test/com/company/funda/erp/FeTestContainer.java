...
public class FeTestContainer extends TestContainer {

    public FeTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/funda/erp/app.properties",
    ...
    public static class Common extends FeTestContainer {

        public static final FeTestContainer.Common INSTANCE = new FeTestContainer.Common();
